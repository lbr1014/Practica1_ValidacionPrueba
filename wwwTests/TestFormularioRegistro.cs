...
namespace wwwTests
{
    ...
    {
        [TestMethod]
        public void TestFormularioRegistroCamposIncompeltosTest()
        {
            IWebDriver driver;
            ...
            driver.FindElement(By.XPath("//form[@id='form1']/div[3]/table/tbody/tr")).Click();
            driver.FindElement(By.Id("txtNombre")).Clear();
            ...
            driver.FindElement(By.Id("txtNombre")).Clear();
            driver.FindElement(By.Id("txtNombre")).SendKeys("Lydia");
            driver.FindElement(By.XPath("//form[@id='form1']/div[3]/table/tbody/tr[2]")).Click();
            driver.FindElement(By.Id("txtApellidos")).Clear();
            driver.FindElement(By.Id("txtApellidos")).SendKeys("");
            driver.FindElement(By.Id("tbxPassword")).Clear();
            driver.FindElement(By.Id("tbxPassword")).SendKeys("ConMasDe12Caracteres!");
            driver.FindElement(By.Id("tbxPassword1")).Clear();
            driver.FindElement(By.Id("tbxPassword1")).SendKeys("ConMasDe12Caracteres!");
            ...
            driver.FindElement(By.Id("txtApellidos")).Clear();
            driver.FindElement(By.Id("txtApellidos")).SendKeys("Llorente");
            driver.FindElement(By.XPath("//form[@id='form1']/div[3]/table/tbody/tr[3]")).Click();
            driver.FindElement(By.Id("txtEmail")).Clear();
            ...
            driver.FindElement(By.Id("txtEmail")).SendKeys("lb@gmail.com");
            driver.FindElement(By.Id("ddlSexo")).Click();
            new SelectElement(driver.FindElement(By.Id("ddlSexo"))).SelectByText("Selecciona una opción");
            driver.FindElement(By.Id("tbxPassword")).Clear();
            driver.FindElement(By.Id("tbxPassword")).SendKeys("ConMasDe12Caracteres!");
            driver.FindElement(By.Id("tbxPassword1")).Clear();
            driver.FindElement(By.Id("tbxPassword1")).SendKeys("ConMasDe12Caracteres!");
            ...
            driver.FindElement(By.Id("ddlSexo")).Click();
            new SelectElement(driver.FindElement(By.Id("ddlSexo"))).SelectByText("Femenino");
            driver.FindElement(By.XPath("//form[@id='form1']/div[3]/table/tbody/tr[5]")).Click();
            driver.FindElement(By.Id("txtPeso")).Clear();
            driver.FindElement(By.Id("txtPeso")).SendKeys("");
            driver.FindElement(By.Id("tbxPassword")).Clear();
            driver.FindElement(By.Id("tbxPassword")).SendKeys("ConMasDe12Caracteres!");
            driver.FindElement(By.Id("tbxPassword1")).Clear();
            driver.FindElement(By.Id("tbxPassword1")).SendKeys("ConMasDe12Caracteres!");
            ...
            driver.FindElement(By.Id("txtPeso")).Clear();
            driver.FindElement(By.Id("txtPeso")).SendKeys("69");
            driver.FindElement(By.XPath("//form[@id='form1']/div[3]/table/tbody")).Click();
            driver.FindElement(By.Id("txtAltura")).Clear();
            driver.FindElement(By.Id("txtAltura")).SendKeys("");
            driver.FindElement(By.Id("tbxPassword")).Clear();
            driver.FindElement(By.Id("tbxPassword")).SendKeys("ConMasDe12Caracteres!");
            driver.FindElement(By.Id("tbxPassword1")).Clear();
            driver.FindElement(By.Id("tbxPassword1")).SendKeys("ConMasDe12Caracteres!");
            ...
            driver.FindElement(By.Id("txtAltura")).Clear();
            driver.FindElement(By.Id("txtAltura")).SendKeys("1,72");
            driver.FindElement(By.XPath("//form[@id='form1']/div[3]/table/tbody/tr[7]")).Click();
            driver.FindElement(By.Id("txtEdad")).Clear();
            driver.FindElement(By.Id("txtEdad")).SendKeys("");
            driver.FindElement(By.Id("tbxPassword")).Clear();
            driver.FindElement(By.Id("tbxPassword")).SendKeys("ConMasDe12Caracteres!");
            driver.FindElement(By.Id("tbxPassword1")).Clear();
            driver.FindElement(By.Id("tbxPassword1")).SendKeys("ConMasDe12Caracteres!");
        ...
        [TestMethod]
        public void TestFormularioRegistroCamposErroneosTest()
        {
            IWebDriver driver;
